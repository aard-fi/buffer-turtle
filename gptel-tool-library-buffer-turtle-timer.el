...
(defvar gptel-tool-library-buffer-turtle-timer-tools '()
  "The list of buffer turtle related tools")

(defvar gptel-tool-library-buffer-turtle-timer-tools-maybe-safe '()
  "The list of buffer turtle related tools which may be destructive, but typically
the LLM behaves.")

(defvar gptel-tool-library-buffer-turtle-timer-tools-unsafe '()
  "The list of buffer turtle related tools which are not safe.")

(add-to-list 'gptel-tool-library-buffer-turtle-timer-tools
             (gptel-make-tool
...
(provide 'gptel-tool-library-buffer-turtle-timer)
